...
HTTP for the Dirthara framework. This repository is the initial package
...
Composer 2.10.3, Mago 1.47.3, and Xdebug.
...
Tests belong in `tests`, under `Dirthara\Http\Tests`. Source belongs in
`src`, under `Dirthara\Http`.
